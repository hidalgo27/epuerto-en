...
@section('title_header')
    ...
    <h3 class="md:text-5xl text-3xl font-medium tracking-widest text-gray-50">Hotels in Cusco</h3>
    <h4 class="md:text-9xl text-5xl font-bold inset-x-0 top-0 -mt-14 text-white text-opacity-10 absolute">Hotels in Cusco</h4>
@endsection
@section('content')
